...
def error_response(error: AppError, *, request_id: str = "", trace_id: str = "") -> dict[str, Any]:
    return {
        "code": error.code,
...
def validation_error_response(message: str, *, request_id: str = "", trace_id: str = "") -> dict[str, Any]:
    return {
